          ...
          <div className="relative min-h-[500px]">
            ...
            >
              ...
              <p className="text-[#4A4A4A] mb-10 font-medium text-[15px] max-w-lg">
                Power your business with high-performance solar energy solutions that cut costs and boost sustainability.
              </p>
          ...
          <div className="flex flex-col md:flex-row gap-16 md:gap-24 items-start mx-auto w-full max-w-6xl">
            <div className="w-full md:w-[55%]">
              ...
              <p className="text-[#4A4A4A] text-[15px] leading-[1.8] mb-10">
                Commercial solar solutions are designed to help businesses reduce their energy expenses and carbon footprint. Whether it&apos;s an office complex, retail chain, or warehouse, our systems are engineered for maximum output and reliability. We handle every aspect from initial assessment to final commissioning, ensuring zero disruption to your business operations.
              </p>
              
              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">Understanding Commercial Solar</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8] mb-10">
                Commercial solar installations work by converting sunlight into usable electricity through high-capacity photovoltaic panels mounted on rooftops or open land. These systems are designed for scale, providing significant energy output to meet the demands of businesses, shops, and commercial complexes. They integrate seamlessly with the existing power grid and can include battery storage for uninterrupted supply.
              </p>

              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">Our Simple Approach</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8] mb-10">
                We start by understanding your business&apos;s energy consumption patterns and available installation space. Our engineering team then designs a custom solar solution optimized for your specific needs. From permits and procurement to installation and grid integration, we manage the full project lifecycle, ensuring a smooth and efficient transition to solar power.
              </p>

              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">What This Provides</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8]">
                Commercial solar systems provide businesses with predictable energy costs, protection against rising electricity tariffs, and a strong sustainability profile. They enhance brand reputation, contribute to ESG goals, and deliver measurable savings that directly impact the bottom line.
              </p>
            </div>
            
            <div className="w-full md:w-[45%] relative h-[450px] md:h-[650px] rounded-3xl overflow-hidden mt-8 md:mt-24 shadow-xl">
               <Image src="/images/rooftop-solar.jpg" alt="Commercial Service Overview" fill className="object-cover" />
            </div>
          </div>
        ...
        <section className="py-28 bg-[#18291c]">
          <motion.div 
            ...
            <div className="flex flex-wrap justify-center md:justify-between items-start gap-12 md:gap-4">
              {[
                { icon: <TrendingDown className="w-7 h-7" />, title: "Reduce Operating\nCosts" },
                { icon: <Building2 className="w-7 h-7" />, title: "Improve Business\nSustainability" },
                { icon: <BarChart3 className="w-7 h-7" />, title: "Higher\nReturn on\nInvestment" },
                { icon: <DollarSign className="w-7 h-7" />, title: "Lower Carbon\nPayments" },
                { icon: <ShieldCheck className="w-7 h-7" />, title: "Reliable\nEnergy\nProduction" },
              ].map((benefit, i) => (
        ...
        <section className="pt-32 pb-32 px-4 md:px-8 max-w-[1400px] mx-auto bg-[#FDFDFD]">
          <motion.div 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { title: "Office Solar\nSystems", desc: "Tailored solutions for corporate offices and co-working spaces.", image: "/images/rooftop-solar.jpg" },
                { title: "Retail & Shopping\nComplexes", desc: "Energy-efficient solar for malls, stores, and retail chains.", image: "/images/rooftop-solar.jpg" },
                { title: "Warehouse Solar\nInstallation", desc: "High-capacity systems for logistics and distribution centers.", image: "/images/rooftop-solar.jpg" },
                { title: "Hybrid Systems\nSolution", desc: "Grid-tied systems with battery backup for uninterrupted power.", image: "/images/rooftop-solar.jpg" }
              ].map((item, i) => (
            ...
            className="max-w-7xl mx-auto px-4 md:px-8">
             <div className="text-center mb-16 relative z-20">
               ...
               <p className="text-[#6A6A6A] text-[15px] max-w-xl mx-auto">
                 Find the perfect balance of affordability and performance for your commercial space.
               </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="rounded-[24px] border border-gray-200 overflow-hidden bg-white flex flex-col">
                  <div className="p-8 pb-6 bg-[#F4F8F5] relative">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#18291c] text-white font-bold text-[14px] mb-4">
                      20 kW
                    </div>
                    <div className="text-[12px] text-[#6A6A6A] font-medium mb-1 line-through">₹ 12,00,000*</div>
                    <div className="flex items-center gap-3">
                      <span className="text-[28px] font-bold text-[#2A2A2A]">₹ 9,50,000*</span>
                  ...
                  <div className="p-8 pt-6 flex-grow flex flex-col">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                       ...
                       <span className="text-[15px] font-medium text-[#4A4A4A]">Suitable for Small Offices / Shops</span>
                    </div>
                ...
                <div className="rounded-[24px] border-2 border-[#18291c] overflow-hidden bg-white flex flex-col relative shadow-xl transform md:-translate-y-4">
                  <div className="p-8 pb-6 bg-[#F4F8F5] relative">
                    <div className="flex items-center gap-3 mb-4">
                      <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#18291c] text-white font-bold text-[14px]">
                        50 kW
                      </div>
                      <span className="px-3 py-1 rounded-full bg-[#FFF3E0] text-[#E65100] text-[11px] font-bold flex items-center gap-1">
                        <span className="w-1.5 h-1.5 rounded-full bg-[#E65100]"></span> Popular Choice
                      </span>
                    </div>
                    <div className="text-[12px] text-[#6A6A6A] font-medium mb-1 line-through">₹ 28,00,000*</div>
                    <div className="flex items-center gap-3">
                      <span className="text-[28px] font-bold text-[#2A2A2A]">₹ 22,50,000*</span>
                      <span className="px-2 py-1 rounded bg-[#E8F3EB] text-[#18291c] text-[12px] font-bold">-20%</span>
                    </div>
                  </div>
                  <div className="p-8 pt-6 flex-grow flex flex-col">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                       <CheckCircle2 className="w-5 h-5 text-[#4a7a53]" />
                       <span className="text-[15px] font-medium text-[#4A4A4A]">Suitable for Medium Offices / Warehouses</span>
                    </div>
                ...
                <div className="rounded-[24px] border border-gray-200 overflow-hidden bg-white flex flex-col">
                  <div className="p-8 pb-6 bg-[#F4F8F5] relative">
                    ...
                    <div className="flex items-center gap-3">
                      <span className="text-[28px] font-bold text-[#2A2A2A]">₹ 44,00,000*</span>
                      <span className="px-2 py-1 rounded bg-[#E8F3EB] text-[#18291c] text-[12px] font-bold">-20%</span>
                    </div>
                  </div>
                  <div className="p-8 pt-6 flex-grow flex flex-col">
                    ...
                    <div className="flex items-center gap-3 mb-8">
                       <CheckCircle2 className="w-5 h-5 text-[#4a7a53]" />
                       <span className="text-[15px] font-medium text-[#4A4A4A]">Suitable for Large Factories / Complexes</span>
                    </div>
                    <button className="w-full py-3.5 rounded-full border border-[#18291c] text-[#18291c] font-bold text-[14px] hover:bg-gray-50 transition-colors mt-auto">
                      Get This System
                    </button>
          ...
          <motion.div 
            ...
            <div className="w-full md:w-1/2 space-y-6">
              ...
              <p className="text-[#6A6A6A] text-sm md:text-[14px] pt-12 pr-12 leading-relaxed">
                Get a personalized estimate including monthly savings, recommended solar capacity, and long-term energy benefits for your business.
              </p>
            </div>
            {/* Right */}
          ...
          <motion.div 
            ...
            <div className="flex flex-col md:flex-row gap-16 items-start">
              <div className="w-full md:w-[45%] relative h-[450px] md:h-[550px] rounded-[30px] overflow-hidden shadow-2xl">
                 <Image src="/images/rooftop-solar.jpg" alt="Commercial Installation" fill className="object-cover" />
              </div>
          ...
          <motion.div 
            ...
            className="max-w-4xl mx-auto px-4 md:px-8">
             ...
             <div className="space-y-0 max-w-3xl mx-auto">
                {[
                  { q: "What size system does my business need?", a: "The system size depends on your monthly electricity consumption. Our team conducts a detailed energy audit to recommend the optimal capacity, typically ranging from 10kW to 500kW+ for commercial setups." },
                  { q: "Will installation disrupt my business operations?", a: "No. We plan and schedule installations to minimize any disruption. Most commercial installations are completed over weekends or during off-peak hours." },
                  { q: "What is the ROI for commercial solar?", a: "Most commercial solar systems pay for themselves within 3-5 years through energy savings, after which you enjoy nearly free electricity for the remaining 20+ year lifespan." },
                  { q: "Are government incentives available for businesses?", a: "Yes, commercial solar installations are eligible for accelerated depreciation benefits, tax incentives, and various state-level subsidies. We assist with all documentation." }
                ].map((faq, i) => (
