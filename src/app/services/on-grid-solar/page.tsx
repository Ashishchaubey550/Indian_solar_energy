            ...
            className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 md:gap-24 items-start">
             ...
             <div className="w-full md:w-1/2">
               ...
               <p className="text-[#4A4A4A] mb-10 font-medium text-[15px] leading-relaxed">
                 An on-grid solar system is connected to the local electrical grid. This setup allows you to use solar energy during the day while utilizing grid power when needed.
               </p>
          ...
          <div className="flex flex-col md:flex-row gap-16 md:gap-24 items-start mx-auto w-full max-w-6xl">
            <div className="w-full md:w-[55%]">
              ...
              <p className="text-[#4A4A4A] text-[15px] leading-[1.8] mb-10">
                An on-grid solar system is highly cost-effective because it does not require expensive batteries. The grid acts as your virtual battery—you send excess power there and draw from it when needed, making it ideal for urban areas with reliable power grids.
              </p>
              
              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">Understanding Net Metering</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8] mb-10">
                Net metering is a billing mechanism that credits solar energy system owners for the electricity they add to the grid. If your solar panels generate more electricity than you use, the excess is sent to the grid, and your meter spins backward, giving you credit.
              </p>

              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">Our Simple Approach</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8] mb-10">
                We handle the complete net metering approval process with your local discom. Our engineers design the optimal system size to zero out your electricity bill while ensuring compliance with all grid regulations and safety standards.
              </p>

              <h3 className="text-[20px] font-bold text-[#2A2A2A] mb-3">What This Provides</h3>
              <p className="text-[#4A4A4A] text-[14.5px] leading-[1.8]">
                By staying connected to the grid, you enjoy the lowest possible installation cost, reliable backup from the utility company during nights or extreme weather, and the ability to monetize your roof space by selling power back to the grid.
              </p>
            </div>
            
            <div className="w-full md:w-[45%] relative h-[450px] md:h-[650px] rounded-[30px] overflow-hidden mt-8 md:mt-24 shadow-xl">
               <Image src="/images/rooftop-solar.jpg" alt="Net Metering" fill className="object-cover" />
            </div>
          </div>
        </section>
            ...
            className="max-w-7xl mx-auto px-4 md:px-8">
             <div className="text-center mb-16 relative z-20">
               ...
               <p className="text-[#6A6A6A] text-[15px] max-w-xl mx-auto">
                 System size depends on your monthly electricity bill and rooftop space.
               </p>
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                ...
                <div className="rounded-[24px] border border-gray-200 overflow-hidden bg-white flex flex-col p-8 text-center shadow-sm">
                  <h3 className="text-2xl font-bold text-[#2A2A2A] mb-1">2 KW</h3>
                  ...
                  <div className="bg-[#E8F3EB] rounded-[16px] py-4 flex flex-col items-center justify-center mb-6">
                    ...
                    <p className="text-[#18291c] font-bold text-[14px]">Suitable for 1BHK / <br/> ₹1,500 - ₹2,000</p>
                  </div>
                  ...
                  <p className="text-[#6A6A6A] text-[13px] font-medium mb-1 line-through">₹1,80,000*</p>
                  <p className="text-[32px] font-bold text-[#2A2A2A] mb-2 leading-none">₹1,20,000*</p>
                  ...
                  <p className="text-[18px] font-bold text-[#2A2A2A] mb-2">₹1,000 - ₹1,500 / month</p>
                  <p className="text-[#A0A0A0] text-[11px] mb-8">Down Payment Required ₹30,000 only</p>
                ...
                <div className="rounded-[24px] border-2 border-[#18291c] overflow-hidden bg-white flex flex-col p-8 text-center shadow-xl transform md:-translate-y-4 relative">
                  ...
                  <h3 className="text-2xl font-bold text-[#2A2A2A] mb-1 mt-4">3 KW</h3>
                  <p className="text-[#6A6A6A] text-[13px] mb-6">Ideal for standard families</p>
                  
                  <div className="bg-[#E8F3EB] rounded-[16px] py-4 flex flex-col items-center justify-center mb-6">
                    <div className="w-10 h-10 rounded-full bg-[#18291c] flex items-center justify-center text-white mb-2 shadow-md">
                       <CheckCircle2 className="w-5 h-5" />
                    </div>
                    <p className="text-[#18291c] font-bold text-[14px]">Suitable for 2BHK / <br/> ₹2,000 - ₹3,000</p>
                  </div>
                  ...
                  <p className="text-[#6A6A6A] text-[13px] font-medium mb-1 line-through">₹2,50,000*</p>
                  <p className="text-[32px] font-bold text-[#2A2A2A] mb-2 leading-none">₹1,82,000*</p>
                  ...
                  <p className="text-[14px] font-bold text-[#4A4A4A] mb-1">EMI Starts</p>
                  <p className="text-[18px] font-bold text-[#2A2A2A] mb-2">₹2,000 - ₹3,000 / month</p>
                  <p className="text-[#A0A0A0] text-[11px] mb-8">Down Payment Required ₹45,000 only</p>
                ...
                {/* 5 kW Card */}
                <div className="rounded-[24px] border border-gray-200 overflow-hidden bg-white flex flex-col p-8 text-center shadow-sm">
                  <h3 className="text-2xl font-bold text-[#2A2A2A] mb-1">5 KW</h3>
                  <p className="text-[#6A6A6A] text-[13px] mb-6">Ideal for large families</p>
                  
                  <div className="bg-[#E8F3EB] rounded-[16px] py-4 flex flex-col items-center justify-center mb-6">
                    <div className="w-10 h-10 rounded-full bg-[#18291c] flex items-center justify-center text-white mb-2 shadow-md">
                       <CheckCircle2 className="w-5 h-5" />
                    </div>
                    <p className="text-[#18291c] font-bold text-[14px]">Suitable for 3BHK / <br/> ₹3,000 - ₹4,000+</p>
                  </div>
                  ...
                  <p className="text-[#6A6A6A] text-[13px] font-medium mb-1 line-through">₹4,00,000*</p>
                  <p className="text-[32px] font-bold text-[#2A2A2A] mb-2 leading-none">₹2,82,000*</p>
                  <p className="text-[#6A6A6A] text-[12px] font-medium mb-8 bg-[#F8F8F8] py-1 px-3 rounded-md mx-auto w-max">Effective Cost After Subsidy</p>

                  <p className="text-[14px] font-bold text-[#4A4A4A] mb-1">EMI Starts</p>
                  <p className="text-[18px] font-bold text-[#2A2A2A] mb-2">₹3,000 - ₹4,000 / month</p>
                  <p className="text-[#A0A0A0] text-[11px] mb-8">Down Payment Required ₹70,000 only</p>
          ...
          <motion.div 
            ...
            className="max-w-4xl mx-auto px-4 md:px-8">
             ...
             <div className="space-y-0 max-w-3xl mx-auto">
                {[
                  { q: "How much space is required for a 3kW system?", a: "A 3kW solar system typically requires about 300 sq. ft. of shadow-free rooftop space." },
                  { q: "What happens during a power cut?", a: "Since on-grid systems are tied to the grid, they automatically shut down during power cuts for safety reasons (anti-islanding). If power cuts are frequent, consider a hybrid system." },
                  { q: "How is the net metering bill calculated?", a: "Your bill is calculated based on the net energy consumed. If you import more than you export, you pay the difference. If you export more, the credit carries forward." },
                  { q: "What is the maintenance required?", a: "On-grid systems require very little maintenance. Just regular cleaning of the panels with water every few weeks ensures maximum efficiency." }
                ].map((faq, i) => (
